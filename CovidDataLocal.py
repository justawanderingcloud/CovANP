...
def covid_general_article_build(general_source):
    ...
    article_part_2 = ["bylo provedeno {} testů. ",
                      "bylo otestováno {} lidí na koronavirus. "]
    ...
    with open(general_source, "r") as dataset:
        ...
        covid_article_parts = [article_part_1_selected.format(datetime_stamp),
